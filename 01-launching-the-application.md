...
When launching the Guru Maps application on your device for the first time, you will see a message asking to access Location Services data. This is a standard request for permission that is generated by all programs that use location services.
...
**Note**: Guru app depends on data services and location-based information might be unavailable, inaccurate, or incomplete unless you turn on Location Services.  
